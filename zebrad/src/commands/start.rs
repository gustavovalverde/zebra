...
impl StartCmd {
    ...
    async fn update_progress(
        ...
        //
        // TODO: reduce this number after slow syncing near tip gets fixed (#3375)
        const MAX_CLOSE_TO_TIP_BLOCKS: i32 = 20;
        ...
        loop {
                ...
                latest_chain_tip.estimate_network_chain_tip_height(network /*, now*/)
            {
                ...
                if is_close_to_tip && remaining_sync_blocks > MAX_CLOSE_TO_TIP_BLOCKS {
                    // We've stopped syncing blocks, but we estimate we're a long way from the tip.
                    warn!(
                        %sync_percent,
                        ?remaining_sync_blocks,
                        "initial sync has stalled, or estimated tip is wrong. \
